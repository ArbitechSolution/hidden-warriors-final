            ...
            <div className="officialLaunch">
                <div>
                    ...
                    <div className="officialLaunchChoice">
                        ...
                        <div>
                            ...
                            <div class="dropdown">
                                ...
                                <a class="dropdown-item" name="1" onClick={this.handleChange}>1</a>
                                    <a class="dropdown-item" name="2" onClick={this.handleChange}>2</a>
                                    <a class="dropdown-item" name="3" onClick={this.handleChange}>3</a>
                                    <a class="dropdown-item" name="4" onClick={this.handleChange}>4</a>
                                    <a class="dropdown-item" name="5" onClick={this.handleChange}>5</a>
                                    <a class="dropdown-item" name="6" onClick={this.handleChange}>6</a>
                                    <a class="dropdown-item" name="7" onClick={this.handleChange}>7</a>
                                    <a class="dropdown-item" name="8" onClick={this.handleChange}>8</a>
                                    <a class="dropdown-item" name="9" onClick={this.handleChange}>9</a>
                                    <a class="dropdown-item" name="10" onClick={this.handleChange}>10</a>
                                    <a class="dropdown-item" name="11" onClick={this.handleChange}>11</a>
                                    <a class="dropdown-item" name="12" onClick={this.handleChange}>12</a>
                                    <a class="dropdown-item" name="13" onClick={this.handleChange}>13</a>
                                    <a class="dropdown-item" name="14" onClick={this.handleChange}>14</a>
                                    <a class="dropdown-item" name="15" onClick={this.handleChange}>15</a>
                                    <a class="dropdown-item" name="16" onClick={this.handleChange}>16</a>
                                    <a class="dropdown-item" name="17" onClick={this.handleChange}>17</a>
                                    <a class="dropdown-item" name="18" onClick={this.handleChange}>18</a>
                                    <a class="dropdown-item" name="19" onClick={this.handleChange}>19</a>
                                    <a class="dropdown-item" name="20" onClick={this.handleChange}>20</a>
                                </div>
                            </div>
                            <span>
                          {this.state.totalPrice} trx 
                        </span>
                        </div>
                    </div>
                    ...
                    <div className="officialLaunchEnd">
                        ...
                        <span>
                            {/* 10000 LEFT token! */}
                            {this.state.notminted} NFTs Left
                        </span>
